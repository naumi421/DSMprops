...
horiz_comps$soc_r <- 0.58 * horiz_comps$om_r # Covert to org carbon
## Parent material
pm.df <- read.csv(paste0(gnatsgotabfldr,"/copm.csv"))
pmgrp.df <- read.csv(paste0(gnatsgotabfldr,"/copmgrp.csv"))
