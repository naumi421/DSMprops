...
predfolder <- "/mnt/disks/sped/solus100preds/v2tst_gnat_pts/ECEC_gRPI_250k"
...
prop <- "ecec_r" ## Dependent variable: UPDATE EVERY TIME
...
## SCD prep for RF
scd.pts.ext.hor$prop <- scd.pts.ext.hor$ecec ## UPDATE everytime!
scdprop <- "ecec"
