...
pts.ext.hor$prop <- pts.ext.hor$ec_r  ## UPDATE EVERY TIME
prop <- "ec_r" ## Dependent variable
...
scd.pts.ext.hor <- subset(scd.pts.ext.hor, scd.pts.ext.hor$prop >= 0) # 10 negative values - not possible for EC.
