...
prop <- "resdept_r" ## Dependent variable: UPDATE EVERY TIME
...
pts.lithic <- readRDS(paste0(predfolder,"/nasis_restrs.rds"))
pts.ext.hor <- left_join(pts.ext, pts.lithic[,c("peiid","resdept_r")], by="peiid")
...
## Now wrangle tables
scd.hor <- readRDS(paste0(predfolder,"/scd_restrs_v2.rds"))
