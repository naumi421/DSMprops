...
predfolder <- "/mnt/disks/sped/solus100preds/v2tst_gnat_pts/SOC_gRPI_250k"
...
prop <- "soc_r" ## Dependent variable: UPDATE EVERY TIME
...
scd.pts.ext.hor$prop <- ifelse(scd.pts.ext.hor$prop < 0, 0, scd.pts.ext.hor$prop) # Correcting slightly negative values to zero.
