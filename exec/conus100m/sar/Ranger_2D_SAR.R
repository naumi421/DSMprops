...
predfolder <- "/push/HYBconus100m/SAR"
repofolder <- "/push/repos/DSMprops/exec/conus100m/SAR"
...
pts.ext.hor$prop <- pts.ext.hor$sar_r ## UPDATE EVERY TIME
...
## SCD prep for RF
scd.pts.ext.hor$prop <- scd.pts.ext.hor$sar ## UPDATE everytime!
scdprop <- "sar"
