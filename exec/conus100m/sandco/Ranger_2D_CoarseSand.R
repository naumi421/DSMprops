...
predfolder <- "/push/HYBconus100m/CoarseSand"
repofolder <- "/push/repos/DSMprops/exec/conus100m/CoarseSand"
...
pts.ext.hor$prop <- pts.ext.hor$sandco_r ## UPDATE EVERY TIME
prop <- "sandco_r" ## Dependent variable
...
## SCD prep for RF
scd.pts.ext.hor$prop <- scd.pts.ext.hor$sand_c_psa ## UPDATE everytime!
scdprop <- "sand_c_psa"
