...
predfolder <- "/mnt/covs/solus_preds/v2tst_gnat_pts/VCoarseSand_gRPI_250k_wtrans"
...
prop <- "sandvc_r" ## Dependent variable: UPDATE EVERY TIME
...
for(d in depths){
  ...
  rasterOptions(maxmemory = 6.5e+09,chunksize = 6e+08, memfrac = 0.9)# maxmemory = 6e+09,chunksize = 6e+08 40-50% cpu, 530GB
  beginCluster(cpus,type='SOCK')
  Sys.time()
