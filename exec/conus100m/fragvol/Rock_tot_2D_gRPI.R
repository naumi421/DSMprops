...
required.packages <- c("raster", "sp", "rgdal", "ranger","caret", "snow", "snowfall","plyr", "dplyr", "ggplot2",
...
predfolder <- "/home/tnaum/data/HYBconus100m/Rock_tot_gRPI"
...
load("/media/sped/Hyb100m_gdrv/2020_Pedons/nasis_pedons_20210325.RData") # object named spc
...
badpeiids <- read.csv("/media/sped/Hyb100m_gdrv/2020_Pedons/nomatch_texmod_peiid.csv",stringsAsFactors = F)
