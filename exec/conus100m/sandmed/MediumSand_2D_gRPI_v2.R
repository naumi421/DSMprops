...
predfolder <- "/mnt/disks/sped/solus100preds/v2tst_gnat_pts/MediumSand_gRPI_250k"
...
prop <- "sandmed_r" ## Dependent variable: UPDATE EVERY TIME
...
for(d in depths){
  ...
  rasterOptions(maxmemory = 6.5e+09,chunksize = 4e+08)# maxmemory = 6e+09,chunksize = 6e+08 40-50% cpu, 530GB
  beginCluster(cpus,type='SOCK')
  Sys.time()
